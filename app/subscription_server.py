...
class RuntimeConfig:
    def __init__(self) -> None:
        ...
        self.profile = SubscriptionProfile(
            ...
            vless_security=_env("VLESS_SECURITY", "tls"),
            vless_type=_env("VLESS_TYPE", "xhttp"),
            vless_sni=_env("VLESS_SNI", "s2.nnqnn.tech"),
            vless_flow=_env("VLESS_FLOW", ""),
            vless_fp=_env("VLESS_FP", "chrome"),
            vless_pbk=_env("VLESS_PBK", ""),
            vless_sid=_env("VLESS_SID", ""),
            vless_path=_env("VLESS_PATH", "/kvpn-xhttp"),
