...
class BillingService:
    ...
    def build_tariffs_text(self) -> str:
        return (
            ...
            "Инструкция по обходу белых списков - это инструкция, с помощью которой вы подключаетесь всего ОДИН раз и сможете пользоваться мобильным интернетом без ограничений."
        )
